...
using WebAppTemplateManager.Api.Filters;
using WebAppTemplateManager.Api.Middleware;

using WebAppTemplateManager.Application;
using WebAppTemplateManager.Infrastructure;
...
var builder = WebApplication.CreateBuilder(args);
{
    ...
    builder.Services.AddSwaggerGen(options => options.SwaggerDoc("v1", new OpenApiInfo { Title = "WebAppTemplateManager.Api", Version = "v7" }));
    //builder.Services.AddDbContext<WebAppTemplateManagerDbContext>(options =>
    //{

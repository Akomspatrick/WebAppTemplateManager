...
namespace DocumentVersionManager.Api.Controllers.v1
{
    public  class CapacityTestPointsController  : DVBaseController<CapacityTestPointsController>
    {
        ...
        private async Task<Either<GeneralFailure, int>> CreateCapacityTestPoint(ApplicationCapacityTestPointCreateDTO createdDto, CancellationToken cancellationToken)
        => await _sender.Send(new CreateCapacityTestPointCommand(createdDto), cancellationToken);
    }
}
...
namespace DocumentVersionManager.Api.Controllers.v1
{
    public  class TestPointsController  : TheBaseController<TestPointsController>
    {
        ...
        //=> result.Select(x => new ModelTypeResponseDTO(x.ModelTypesId, x.ModelTypesName, CovertTestPointResponse(x.Models)));
        ...
        private TestPointResponseDTO MapApplicationTestPointResponseDTO_To_TestPointResponseDTO(ApplicationTestPointResponseDTO result)
        => throw new NotImplementedException("Please implement like below");

...
{
    public  class DeleteCapacityDocumentCommandHandler  :  IRequestHandler<DeleteCapacityDocumentCommand, Either<GeneralFailures, int>>
    {
        ...
        public async Task<Either<GeneralFailures, int>> Handle(DeleteCapacityDocumentCommand request, CancellationToken cancellationToken)
        {

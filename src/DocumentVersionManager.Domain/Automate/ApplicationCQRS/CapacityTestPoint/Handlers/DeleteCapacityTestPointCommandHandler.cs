...
{
    public  class DeleteCapacityTestPointCommandHandler  :  IRequestHandler<DeleteCapacityTestPointCommand, Either<GeneralFailure, int>>
    {
        ...
        public async Task<Either<GeneralFailure, int>> Handle(DeleteCapacityTestPointCommand request, CancellationToken cancellationToken)
        {

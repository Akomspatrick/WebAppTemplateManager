...
{
    public  class CreateRevisionCapacityIntervalCommandHandler  :  IRequestHandler<CreateRevisionCapacityIntervalCommand, Either<GeneralFailure, int>>
    {
        ...
        public async Task<Either<GeneralFailure, int>> Handle(CreateRevisionCapacityIntervalCommand request, CancellationToken cancellationToken)
        {

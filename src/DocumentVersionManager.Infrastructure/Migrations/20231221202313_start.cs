    ...
    public partial class start : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "FIRSTMODELNAME", 1, "CLASS", true, "APPLICATION", "CCNUMBER", 100, 20, "AUTOMATIC", new Guid("b27c2c19-522b-49d1-83bf-e80d4dde8c63"), 1, "FIRST_VERSION_FIRSTMODEL_NAME", "NTEPCERTIFICATIONID", new DateTime(2023, 12, 21, 20, 23, 12, 543, DateTimeKind.Utc).AddTicks(812), 1.0, 1m, 1m, 1, "OIMLCERTIFICATIONID1", new DateTime(2023, 12, 21, 20, 23, 12, 543, DateTimeKind.Utc).AddTicks(812), 1, 1, "SHELLMATERIAL1", 1, 1, true, new DateTime(2023, 12, 21, 20, 23, 12, 543, DateTimeKind.Utc).AddTicks(808), 1, "OLADEJI", "SPECIAL DESIGN", 1, 1.0 },
                    { "FIRSTMODELNAME", 2, "CLASS", true, "APPLICATION", "CCNUMBER", 100, 20, "MANUAL", new Guid("7808711f-544a-423d-8d99-f00c31e35be5"), 2, "SECOND_VERSION_FIRSTMODELNAME", "NTEPCERTIFICATIONID", new DateTime(2023, 12, 21, 20, 23, 12, 543, DateTimeKind.Utc).AddTicks(846), 2.0, 2m, 2m, 2, "OIMLCERTIFICATIONID1", new DateTime(2023, 12, 21, 20, 23, 12, 543, DateTimeKind.Utc).AddTicks(846), 2, 2, "SHELLMATERIAL1", 2, 2, true, new DateTime(2023, 12, 21, 20, 23, 12, 543, DateTimeKind.Utc).AddTicks(839), 2, "OLADEJI", "AUTO DESIGN TO COMBAT SPLIILING", 2, 2.0 },
                    { "SECONDMODELNAME", 1, "CLASS", true, "APPLICATION", "CCNUMBER", 100, 20, "GETVALUESFROMTESTINGFLOWTYPES", new Guid("58dcf5c5-5a00-4ffa-bb37-9374a8d3c69b"), 1, "FIRST_VERSION_SECONDMODELNAME", "NTEPCERTIFICATIONID", new DateTime(2023, 12, 21, 20, 23, 12, 543, DateTimeKind.Utc).AddTicks(851), 1.0, 1m, 1m, 1, "OIMLCERTIFICATIONID1", new DateTime(2023, 12, 21, 20, 23, 12, 543, DateTimeKind.Utc).AddTicks(852), 1, 1, "SHELLMATERIAL1", 1, 1, true, new DateTime(2023, 12, 21, 20, 23, 12, 543, DateTimeKind.Utc).AddTicks(851), 1, "OLADEJI", "INITIAL DESIGN", 1, 1.0 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "FIRSTMODELNAME ver1 DOc", "FIRSTMODELNAME", 1, "CHANGE ORDER PATH", "CONTENT PDF PATH", "DOCPATHID", "SIMPLE DESCRITION OF DOCUMENT", new Guid("b27c2c19-522b-49d1-83bf-e80d4dde8c63"), new DateTime(2023, 12, 21, 20, 23, 12, 536, DateTimeKind.Utc).AddTicks(7447) },
                    { "FIRSTMODELNAME ver1 DOc A", "FIRSTMODELNAME", 1, "CHANGE ORDER PATH", "CONTENT PDF PATH", "DOCPATHID", "SIMPLE DESCRITION OF DOCUMENT", new Guid("b27c2c19-522b-49d1-83bf-e80d4dde8c63"), new DateTime(2023, 12, 21, 20, 23, 12, 536, DateTimeKind.Utc).AddTicks(7467) },
                    { "FIRSTMODELNAME ver1 DOc B", "FIRSTMODELNAME", 1, "CHANGE ORDER PATH", "CONTENT PDF PATH", "DOCPATHID", "SIMPLE DESCRITION OF DOCUMENT", new Guid("7808711f-544a-423d-8d99-f00c31e35be5"), new DateTime(2023, 12, 21, 20, 23, 12, 536, DateTimeKind.Utc).AddTicks(7469) },
                    { "FIRSTMODELNAME ver2 DOc A", "FIRSTMODELNAME", 2, "CHANGE ORDER PATH", "CONTENT PDF PATH", "DOCPATHID", "SIMPLE DESCRITION OF DOCUMENT", new Guid("58dcf5c5-5a00-4ffa-bb37-9374a8d3c69b"), new DateTime(2023, 12, 21, 20, 23, 12, 536, DateTimeKind.Utc).AddTicks(7471) }
                });

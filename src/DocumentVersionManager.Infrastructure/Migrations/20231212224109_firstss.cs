    ...
    public partial class firstss : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CapacityTestPoints", x => x.TestId);
                    table.ForeignKey(
                        name: "FK_CapacityTestPoints_Specifications_ModelName_ModelVersionId",
                        columns: x => new { x.ModelName, x.ModelVersionId },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "FIRSTMODELNAME", 1, new Guid("b27c2c19-522b-49d1-83bf-e80d4dde8c63"), "FIRST_VERSION_FIRSTMODEL_NAME", "", new DateTime(2023, 12, 12, 22, 41, 9, 581, DateTimeKind.Utc).AddTicks(8469), "OLADEJI", "SPECIAL DESIGN" },
                    { "FIRSTMODELNAME", 2, new Guid("7808711f-544a-423d-8d99-f00c31e35be5"), "SECOND_VERSION_FIRSTMODELNAME", "", new DateTime(2023, 12, 12, 22, 41, 9, 581, DateTimeKind.Utc).AddTicks(8485), "OLADEJI", "AUTO DESIGN TO COMBAT SPLIILING" },
                    { "SECONDMODELNAME", 1, new Guid("58dcf5c5-5a00-4ffa-bb37-9374a8d3c69b"), "FIRST_VERSION_SECONDMODELNAME", "", new DateTime(2023, 12, 12, 22, 41, 9, 581, DateTimeKind.Utc).AddTicks(8487), "OLADEJI", "INITIAL DESIGN" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "FIRSTMODELNAME ver1 DOc", "FIRSTMODELNAME", 1, "CHANGE ORDER PATH", "CONTENT PDF PATH", "001", "SIMPLE DESCRITION OF DOCUMENT", new Guid("b27c2c19-522b-49d1-83bf-e80d4dde8c63"), new DateTime(2023, 12, 12, 22, 41, 9, 578, DateTimeKind.Utc).AddTicks(2893) },
                    { "FIRSTMODELNAME ver1 DOc A", "FIRSTMODELNAME", 1, "CHANGE ORDER PATH", "CONTENT PDF PATH", "001", "SIMPLE DESCRITION OF DOCUMENT", new Guid("b27c2c19-522b-49d1-83bf-e80d4dde8c63"), new DateTime(2023, 12, 12, 22, 41, 9, 578, DateTimeKind.Utc).AddTicks(2904) },
                    { "FIRSTMODELNAME ver1 DOc B", "FIRSTMODELNAME", 1, "CHANGE ORDER PATH", "CONTENT PDF PATH", "001", "SIMPLE DESCRITION OF DOCUMENT", new Guid("7808711f-544a-423d-8d99-f00c31e35be5"), new DateTime(2023, 12, 12, 22, 41, 9, 578, DateTimeKind.Utc).AddTicks(2911) },
                    { "FIRSTMODELNAME ver2 DOc A", "FIRSTMODELNAME", 2, "CHANGE ORDER PATH", "CONTENT PDF PATH", "001", "SIMPLE DESCRITION OF DOCUMENT", new Guid("58dcf5c5-5a00-4ffa-bb37-9374a8d3c69b"), new DateTime(2023, 12, 12, 22, 41, 9, 578, DateTimeKind.Utc).AddTicks(2913) }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "FIRSTMODELNAME", 1, true, "APPLICATION", "CCNUMBER", 100, "CLASS", 20, new Guid("58dcf5c5-5a00-4ffa-bb37-9374a8d3c69b"), 1, "NTEPCERTIFICATIONID", new DateTime(2023, 12, 12, 22, 41, 9, 583, DateTimeKind.Utc).AddTicks(5901), 1.0, 1m, 1m, 1, "OIMLCERTIFICATIONID1", new DateTime(2023, 12, 12, 22, 41, 9, 583, DateTimeKind.Utc).AddTicks(5901), 1, 1, "SHELLMATERIAL1", 1, 1, new DateTime(2023, 12, 12, 22, 41, 9, 583, DateTimeKind.Utc).AddTicks(5899), 1, "OLADEJI", 1, 1.0 },
                    { "FIRSTMODELNAME", 2, true, "APPLICATION", "CCNUMBER", 100, "CLASS", 20, new Guid("58dcf5c5-5a00-4ffa-bb37-9374a8d3c69b"), 1, "NTEPCERTIFICATIONID", new DateTime(2023, 12, 12, 22, 41, 9, 583, DateTimeKind.Utc).AddTicks(5919), 1.0, 1m, 1m, 1, "OIMLCERTIFICATIONID2", new DateTime(2023, 12, 12, 22, 41, 9, 583, DateTimeKind.Utc).AddTicks(5920), 1, 1, "SHELLMATERIAL2", 1, 1, new DateTime(2023, 12, 12, 22, 41, 9, 583, DateTimeKind.Utc).AddTicks(5919), 1, "OLADEJI", 1, 1.0 },
                    { "SECONDMODELNAME", 1, true, "APPLICATION", "CCNUMBER", 100, "CLASS", 20, new Guid("58dcf5c5-5a00-4ffa-bb37-9374a8d3c69b"), 1, "NTEPCERTIFICATIONID", new DateTime(2023, 12, 12, 22, 41, 9, 583, DateTimeKind.Utc).AddTicks(5925), 1.0, 1m, 1m, 1, "OIMLCERTIFICATIONID3", new DateTime(2023, 12, 12, 22, 41, 9, 583, DateTimeKind.Utc).AddTicks(5925), 1, 1, "SHELLMATERIAL3", 1, 1, new DateTime(2023, 12, 12, 22, 41, 9, 583, DateTimeKind.Utc).AddTicks(5924), 1, "OLADEJI", 1, 1.0 }
                });

            migrationBuilder.InsertData(
                table: "CapacityTestPoints",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CapacityTestPoints_ModelName_ModelVersionId",
                table: "CapacityTestPoints",

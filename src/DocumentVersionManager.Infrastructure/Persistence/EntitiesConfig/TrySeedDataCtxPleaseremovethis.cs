...
{
    public static class TrySeedDataCtxPleaseremovethis
    {


        public async static Task EnsureUsers(this DocumentVersionManagerContext ctx)
        {
                ...
                try
                {
                    ...
                    // if (await ctx.Database.EnsureCreatedAsync())
                    {
                        ...
                        if (!documents)
                        {
                            ...
                            {
                                Document.Create("FIRSTMODELNAME ver1 DOc", "FIRSTMODELNAME", 1, "CONTENT PDF PATH", "CHANGE ORDER PATH", "DOCPATHID", "SIMPLE DESCRITION OF DOCUMENT", DateTime.UtcNow, Guid.Parse("b27c2c19-522b-49d1-83bf-e80d4dde8c63")),
                        ...
                        if (!testPoints)
                        {
                            ...
                            {
                                TestPoint.Create("FIRSTMODELNAME", 1, 10000, Guid.Parse("b27c2c19-522b-49d1-83bf-e80d4dde8c63")),

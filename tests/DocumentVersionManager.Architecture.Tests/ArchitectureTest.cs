...
namespace DocumentVersionManager.Architecture.Tests
{
    public class ArchitectureTest
    {
        public class ArchitectuteTest
        {
            ...
            private const string DomainNamesspace = "DocumentVersionManager.Domain";
            private const string InfrastructureNamespace = "DocumentVersionManager.Infrastructure";
            private const string ApplicationNamespace = "DocumentVersionManager.Application";
            private const string Presentation = "DocumentVersionManager.Api";
            private const string Contract = "DocumentVersionManager.Contracts";
            private const string DomainBaseNamesspace = "DocumentVersionManager.DomainBase";
            private const string BaseModels = "DocumentVersionManager.BaseModels";
